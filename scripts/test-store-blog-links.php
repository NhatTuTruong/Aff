...
$html = '<p><a href="https://reviewvera.com/store/demo-store">Coupons</a></p>'
    .'<p><a href="/store/demo-store">More</a></p>';

$result = $method->invoke($service, $html, 'demo-store', $affiliate);

$ok = ! str_contains($result, '/store/demo-store') && str_contains($result, '/out/demo-store');
echo $ok ? "PASS\n" : "FAIL\n{$result}\n";
exit($ok ? 0 : 1);
