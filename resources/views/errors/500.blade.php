...
<style>
    ...
    .error-page .error-code { font-family: 'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif; font-size: 6rem; font-weight: 700; line-height: 1; color: #dc2626; margin-bottom: 0.5rem; }
